  ...
  return (
    <div className="flex flex-col w-full max-w-xl mx-auto px-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
        <a href="mailto:jowoen@gmail.com" className="flex items-start gap-3 border border-gray-700 rounded-xl p-4 bg-background hover:bg-background/80 transition shadow group">
        ...
        <a href="https://instagram.com/jowoen" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 border border-gray-700 rounded-xl p-4 bg-background hover:bg-background/80 transition shadow group">
        ...
        <a href="https://linkedin.com/in/jowoen" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 border border-gray-700 rounded-xl p-4 bg-background hover:bg-background/80 transition shadow group">
        ...
        <a href="https://discord.com/users/jowoen" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 border border-gray-700 rounded-xl p-4 bg-background hover:bg-background/80 transition shadow group">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
      <a href="/files/CV.pdf" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 border border-gray-700 rounded-xl p-4 bg-background hover:bg-background/80 transition shadow group">
        ...
        <a href="/files/PORTFOLIO.pdf" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 border border-gray-700 rounded-xl p-4 bg-background hover:bg-background/80 transition shadow group">
